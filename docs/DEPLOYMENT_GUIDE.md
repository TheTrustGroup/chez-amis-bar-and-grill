...
NEXT_PUBLIC_EMAIL=info@chezamisrestaurant.com
...
NEXT_PUBLIC_API_URL=https://api.chezamisrestaurant.com
...
2. Add your domain: `chezamisrestaurant.com` and `www.chezamisrestaurant.com`
...
**For Root Domain (chezamisrestaurant.com):**
```
Type: A
Name: @
Value: 76.76.21.21
...
**For WWW (www.chezamisrestaurant.com):**
```
Type: CNAME
Name: www
...
export async function POST(request: Request) {
  try {
    ...
    await resend.emails.send({
      from: 'contact@chezamisrestaurant.com',
      to: 'info@chezamisrestaurant.com',
