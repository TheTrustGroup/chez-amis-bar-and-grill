...
export function FounderStory() {
  ...
  const blockClass = cn(
    "card-padding rounded-xl transition-all duration-300",
    isDark ? "border border-green-700/50 bg-green-600/50" : "border border-border/30 bg-neutral-50/50",
    "hover:border-terra-500/30 hover:shadow-lg",
  )
          ...
          <div className="group relative order-2 h-[500px] w-full md:order-1 md:h-[600px] lg:h-[700px] section-split-half">
            <div
              className={cn(
                ...
                "group-hover:border-terra-500/40 group-hover:shadow-[0_30px_80px_rgba(0,0,0,0.4)]",
              )}
            >
              <Image
                ...
                fill
                className="object-cover object-center brightness-110 contrast-110 saturate-110 transition-transform duration-700 ease-out group-hover:scale-110"
                priority
              ...
              <div className="absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100 bg-gradient-to-br from-terra-500/10 via-transparent to-transparent" />

              <div className="pointer-events-none absolute inset-0 rounded-2xl border border-white/10" />
            </div>

            <div
              className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-terra-500/10 opacity-0 blur-3xl transition-opacity duration-700 group-hover:opacity-100"
              aria-hidden="true"
            />
          </div>
