            ...
            <div>
              ...
              <div className="space-y-2 mb-4">
                <a
                  ...
                  className="block text-base md:text-lg text-foreground font-body font-light hover:text-terra-600 transition-colors"
                >
                  +233 055 703 2312
                </a>
                <a
        ...
        <CardContent className="card-padding space-y-5 flex-1 flex flex-col">
          ...
          <div className="space-y-3 text-base md:text-lg text-foreground font-body font-light flex-1">
            <div>
              ...
              <p className="text-2xl md:text-3xl text-terra-600 font-display font-light">24/7</p>
            </div>
          </div>
