...
export function MapSection() {
  ...
  return (
    <section className="section-shell bg-neutral-50" aria-labelledby="location-heading">
      <div className="section-shell-inner">
        {/* Section Header */}
        <div className="text-center section-heading-margin">
          <h2
            id="location-heading"
            className="section-title text-foreground mb-3"
          >
            Visit Us
          </h2>
        ...
        <div className="section-split items-start">
          ...
          <div
            className="section-split-half relative order-2 md:order-1 rounded-xl overflow-hidden shadow-2xl h-[300px] sm:h-[400px] md:h-[500px] group"
          ...
          >
            ...
            <div className="absolute inset-0 border-2 border-terra-500/20 rounded-xl pointer-events-none"></div>
          ...
          <div className="section-split-half space-y-4 md:space-y-6 order-1 md:order-2">
            ...
            <div className="bg-terra-500/5 rounded-lg card-padding border border-terra-500/20">
              ...
              <ul className="space-y-3 text-sm md:text-base text-muted-foreground font-body font-light">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-terra-500 rounded-full mt-2 flex-shrink-0"></span>
        ...
        {/* Additional Info Bar */}
        <div className="mt-8 md:mt-12 bg-green-600 text-white rounded-lg card-padding">
          <div className="grid grid-cols-1 sm:grid-cols-3 grid-gap-section text-center">
            <div className="py-2">
              <p className="text-terra-400 font-body font-medium mb-1 text-sm md:text-base">Parking Available</p>
              <p className="text-xs md:text-sm text-white/70 font-body font-light">Complimentary parking</p>
            </div>
            <div className="py-2">
              <p className="text-terra-400 font-body font-medium mb-1 text-sm md:text-base">Wheelchair Accessible</p>
              <p className="text-xs md:text-sm text-white/70 font-body font-light">All facilities accessible</p>
            </div>
            <div className="py-2">
              <p className="text-terra-400 font-body font-medium mb-1 text-sm md:text-base">Private Dining</p>
              <p className="text-xs md:text-sm text-white/70 font-body font-light">Rooms available for events</p>
            </div>
          </div>
        </div>
      </div>
