  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
        <div className="group">
          <Label 
            htmlFor="name" 
            className={cn(
              "font-body font-medium mb-2 block transition-colors duration-300",
              "group-focus-within:text-terra-600",
              isDark ? "text-white/90" : "text-foreground"
            )}
          >
            Your Name <span className="text-terra-600">*</span>
          </Label>
          <Input
            id="name"
            type="text"
      ...
      <div className="group">
        ...
        >
          Reason for Contacting <span className="text-terra-600">*</span>
        </Label>
        <select
          id="reason"
      ...
      <div className="group">
        ...
        >
          Your Message <span className="text-terra-600">*</span>
        </Label>
        <Textarea
          id="message"
