    ...
    >
      <div className="section-shell-inner w-full">
        <div className="flex flex-col items-center gap-3">
          <ul className="scrollbar-hide flex max-w-full snap-x snap-mandatory flex-wrap justify-center gap-3 overflow-x-auto pb-0.5 md:gap-4">
            {items.map((label) => (
              <li
                key={label}
          ...
          <div className="flex min-h-[48px] w-full max-w-sm snap-center items-center justify-center gap-2 rounded-full border border-white/20 bg-white/15 px-4 py-2 font-body text-xs font-medium uppercase tracking-wide">
