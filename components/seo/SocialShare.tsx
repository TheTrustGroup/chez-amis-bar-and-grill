...
import { Facebook, Twitter, Instagram, Share2, Link as LinkIcon } from "lucide-react"
...
export function SocialShare({ 
  ...
  description = "Experience exceptional culinary artistry and warm hospitality in the heart of Accra."
}: SocialShareProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      <span className="text-sm font-body font-light text-muted-foreground mr-2">
        Share:
      </span>
      ...
      {typeof window !== 'undefined' && 'share' in navigator && (
        <button
          ...
          className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-charcoal-800 hover:bg-charcoal-700 text-cream-100 transition-colors"
          aria-label="Share"
        >
